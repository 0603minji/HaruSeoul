  ...
  <main>
    <section class="reservation-detail">
      ...
      <section class="content">
        ...
        <section v-if="requirement">
          ...
          <div>
            <details open>
              ...
              <div class="details">
                <div class="info" style="align-items: center; flex-direction: column">
                  <span class="info-form" style="font-size: 15px; color: var(--color-main-3)">[ 호스트 요청 사항 ]</span>
                  <span class="info-input" style="padding:0 16px; font-size: 15px; color: var(--color-main-3)">
                     {{ requirement.hostRequirement }}
                  </span>
                </div>
                <div class="info" style=" align-items: center; flex-direction: column">
                  <span class="info-form" style="font-size: 15px;">[ 게스트 요청 사항 ]</span>
                  <span class="info-input" style="padding:0 16px; font-size: 15px;">
        ...
        <div
            v-if="['Finished', 'Confirmed'].includes(reservation.statusName)"
            style="
            display: flex;
