      ...
      <section id="intro" class="intro">
        ...
        <div class="form-group">
          ...
          <div class="char-counter">
            <span v-if="programCreateDto.title">{{ programCreateDto.title.length }}/60</span>
          </div>
        </div>
      ...
      <section id="detail" class="detail">
        ...
        <div class="form-group d:flex">
          ...
          <input type="number" name="cost" class="input-text no-spinner" min="0" max="1000000"
                 v-model="programCreateDto.price">
...
const sendCreateRequest = async () => {
  ...
  formData.append("programUpdateDto", new Blob([JSON.stringify(programData)], {type: "application/json"}));
...
const loadProgramData = async () => {
  try {
    ...
    console.log("Loaded data into form:", programCreateDto);
  } catch (error) {
...
//   return (
//       (programCreateDto.title || '').length > 60 ||
