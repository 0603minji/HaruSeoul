<template>
  <Head>
      <Title> Guest Reservation List 페이지 </Title>
  </Head>
    ...
    <section class="bg-color:base-1 n-layout-mj">
      ...
      <section class="n-filter n-filter-rv bg-color:base-1 padding-x:6">
        ...
        <div class="overflow-x:auto">
          <ul class="item-wrapper padding-y:6">
            ...
            <li>
              <a href="" class="n-btn n-btn n-btn-rv-filter n-btn:hover"
                >예약 중</a
              >
            </li>
            <li>
      ...
      <ul class="n-card-container bg-color:base-1">
        ...
        <li class="n-card bg-color:base-1 padding:6">
          ...
          <div class="card-header">
            <div class="left">
              <span class="n-panel-tag completed">이용완료</span>
            </div>
          </div>
        ...
        <li class="n-card bg-color:base-1 padding:6">
          ...
          <div class="card-header">
            <div class="left">
              <span class="n-panel-tag canceled">취소됨</span>
            </div>
          </div>

          <div class="card-main">
            <div class="img-wrapper">
              <img src="/image/guest/program_03.png" alt="대표사진" />
            </div>
