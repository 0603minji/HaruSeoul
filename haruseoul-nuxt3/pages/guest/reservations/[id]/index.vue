<template>
  <Head>
      <Title> Guest Reservation Detail 페이지 </Title>
  </Head>
            ...
            <details open>
              ...
              <div class="details">
                <div class="info">
                  ...
                  <span class="info-input">김민석</span>
                </div>
                <div class="info">
                  <span class="info-form">이메일</span>
                  <span class="info-input">email@email.com</span>
                </div>
                <div class="info">
                ...
                <div class="info">
                  ...
                  <span class="info-input n-icon n-icon:instagram"
                    >@instagram</span
                  >
                </div>
              </div>
              ...
              <div class="details">
                ...
                <div class="info">
                  ...
                  <div style="padding-right: 0">
                    <span class="info-input" style="justify-content: right"
                      >Credit card</span
                    >
                    <span class="info-input n-icon n-icon:credit_card"
                      >1234 1245 1234 1234</span
                    >
                  </div>
                </div>
                <div
                  class="info"
                  style="margin-bottom: 13px; align-items: center"
                >
              ...
              <section class="profile-card">
                ...
                <div class="overview">
                  ...
                  <div>
                    <div>Jasmin</div>
                    <div
                      class="n-icon n-icon:star n-deco"
                      style="--deco-gap: 3px"
                    >
                      <span>4.5 / 5.0</span>
                      <span>(999)</span>
                      ...
                      <div class="details">
                        <section style="padding-top: 0">
                          ...
                          <div class="info-container">
                            ...
                            >
                              <span
                                class="n-icon n-icon:placeholder"
                          ...
                          <div>
                            ...
                            <ul>
                              ...
                              <li class="list-content">
                                여행일 변경 및 타인 양도가 가능한 상품입니다.
                              </li>
                              <li class="list-content">
                                여행일 변경 및 타인 양도 희망시 상기 연락처를
                                통해 연락 바랍니다.
                              </li>
                              <li class="list-content">
                                악천후 관련 취소 시 사전에 연락을 드립니다.
                              </li>
                              <li class="list-content">
                                악천후 취소 기준은 시간당 강수량 10mm 이상, 기온
                                -5도 이하이며, 여행 전일 여행시간대 기상청
                                예보를 기준으로 합니다.
                              </li>
                            </ul>
                          </div>
...
<style scoped>
@import url("/css/guest/reservation/detail.css");
</style>
