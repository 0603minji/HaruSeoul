        ...
        <section>
          ...
          <header class="list-header bg-color:base-1">
            ...
            <div>
              ...
              <!--            </button>-->
              <a href=""
                 class="n-icon n-icon:arrow_swap n-deco n-deco-gap:1">
                정렬
              </a>
            </div>
          </header>
          ...
          <ul class="n-card-container bg-color:base-1 padding:7">
            <!-- =================================== 작성 중 예약 카드 1개 =================================== -->
            <li class="n-card bg-color:base-1 padding:6">
              <h2 class="d:none">프로그램 카드</h2>

              <div class="card-header">
                <div class="left">
                  <span class="n-panel-tag not-submitted">작성 중</span>
                </div>
                <div class="right">
            ...
            <li class="n-card bg-color:base-1 padding:6">
              ...
              <div class="card-header">
                <div class="left">
                  <span class="n-panel-tag submitted">작성 완료</span>
                </div>
                <div class="right">
                  <a href="" class="n-icon n-icon:more_vertical n-icon-size:4 n-icon-color:base-9">더보기</a>
                </div>
              ...
              <div class="card-main">
                ...
                <div class="card-info-wrapper">
                  ...
                  <div class="card-info-responsive">
                    ...
                    <div class="card-footer-responsive">
                      <a href="aa" class="n-btn open">개설하기</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!-- =================================== 모집 중 예약 카드 1개 =================================== -->
            <li class="n-card bg-color:base-1 padding:6">
              <a class="n-link-box" href="/guest/program/detail?id=1"></a>
              <h2 class="d:none">프로그램 카드</h2>

              <div class="card-header">
                <div class="left">
                  <span class="n-panel-tag open">모집 중</span>
                </div>
                <div class="right">
                  <a href="" class="n-icon n-icon:more_vertical n-icon-size:4 n-icon-color:base-9">더보기</a>
                </div>
              ...
              <div class="card-main">
                ...
                <div class="card-info-wrapper">
                  ...
                  <div class="card-info-responsive">
                    ...
                    <div class="card-footer-responsive">
                      <a href="aa" class="n-btn manage">예약관리</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-footer">
                <a href="../reservation/list?id=1" class="n-btn manage">예약 관리</a>
              </div>
            </li>
          </ul>
        ...
        <div class="filters">
          ...
          <details open class="filter">
            ...
            <form action="" class="form">
              <div class="modal-checkbox">
                <label><input type="checkbox">All</label>
                <label><input type="checkbox">Gyeong-bok-gung Palace Tour With Wearing Han-bok</label>
                <label><input type="checkbox">Gyeong-bok-gung Palace Tour With Wearing Han-bok</label>
                <label><input type="checkbox">Gyeong-bok-gung Palace Tour With Wearing Han-bok</label>
                <label><input type="checkbox">Gyeong-bok-gung Palace Tour With Wearing Han-bok</label>
                <label><input type="checkbox">Gyeong-bok-gung Palace Tour With Wearing Han-bok</label>
